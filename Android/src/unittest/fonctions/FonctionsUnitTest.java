...
public class FonctionsUnitTest {
	...
	public void test() {
		try {
			interpreter.execute(Openfile.fileReader(FonctionsUnitTest.class.getResource("unitTest1.logo").getPath()));
	...
	public void test2() {
		try {
			interpreter.execute(Openfile.fileReader(FonctionsUnitTest.class.getResource("unitTest2.logo").getPath()));
			assertEquals(0,interpreter.getTurtle().getX(),0.00000001);
	...
	// test de fonction avec primitive apr̬s la fonction
		...
		public void test3() {
			try {
				interpreter.execute(Openfile.fileReader(FonctionsUnitTest.class.getResource("unitTest3.logo").getPath()));
		...
		public void test4() {
			try {
				interpreter.execute(Openfile.fileReader(FonctionsUnitTest.class.getResource("unitTest4.logo").getPath()));
